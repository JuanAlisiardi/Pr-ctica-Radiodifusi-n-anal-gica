...
class MPX(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "MPX")
        ...
        self.analog_sig_source_x_3 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, frec_R, 0, 0, 0)
        self.analog_sig_source_x_2 = analog.sig_source_f(samp_rate, analog.GR_COS_WAVE, frec_L, 0, 0, 0)
        self.analog_sig_source_x_1 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 38e3, 1, 0, 0)
        self.analog_sig_source_x_0 = analog.sig_source_f(samp_rate, analog.GR_SIN_WAVE, 19e3, 0.1, 0, 0)
        self.analog_fm_preemph_1 = analog.fm_preemph(fs=samp_rate, tau=(75e-6), fh=(-1.0))
        ...
        self.connect((self.analog_fm_preemph_1, 0), (self.blocks_add_xx_0, 1))
        self.connect((self.analog_fm_preemph_1, 0), (self.blocks_sub_xx_0, 1))
        ...
        self.connect((self.analog_sig_source_x_2, 0), (self.analog_fm_preemph_0, 0))
        self.connect((self.analog_sig_source_x_3, 0), (self.analog_fm_preemph_1, 0))
        self.connect((self.blocks_add_xx_0, 0), (self.blocks_add_xx_1, 2))
...
def main(top_block_cls=MPX, options=None):
