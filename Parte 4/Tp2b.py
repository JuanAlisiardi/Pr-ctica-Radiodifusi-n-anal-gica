...
class Tp2b(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_gr_complex*1, 'C:\\Users\\Usuario\\Downloads\\fm.dat', True, 0, 0)
        ...
        # Connections
        ##################################################
        self.connect((self.analog_quadrature_demod_cf_0, 0), (self.blocks_peak_detector2_fb_0, 0))
        self.connect((self.analog_quadrature_demod_cf_0, 0), (self.blocks_rms_xx_0, 0))
        self.connect((self.analog_quadrature_demod_cf_0, 0), (self.blocks_sample_and_hold_xx_0, 0))
        ...
        self.connect((self.blocks_sample_and_hold_xx_0, 0), (self.qtgui_number_sink_0, 1))
...
def main(top_block_cls=Tp2b, options=None):
